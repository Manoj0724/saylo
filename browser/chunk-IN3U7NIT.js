...
var RegisterComponent = class _RegisterComponent {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _RegisterComponent, selectors: [["app-register"]], decls: 29, vars: 8, consts: [[1, "auth-shell"], [1, "auth-card"], [1, "auth-logo"], [1, "auth-title"], [1, "auth-sub"], [1, "auth-error"], [1, "auth-form"], [1, "field"], ["type", "text", "placeholder", "Your name", 3, "ngModelChange", "keydown.enter", "ngModel"], ["type", "email", "placeholder", "you@example.com", 3, "ngModelChange", "keydown.enter", "ngModel"], ["type", "password", "placeholder", "Min 8 characters", 3, "ngModelChange", "keydown.enter", "ngModel"], [1, "auth-btn", 3, "click", "disabled"], [1, "spinner"], [1, "auth-link"], ["routerLink", "/login"]], template: function RegisterComponent_Template(rf, ctx) {
    if (rf & 1) {
      ...
      \u0275\u0275text(7, "Join Saylo today");
      \u0275\u0275elementEnd();
      \u0275\u0275conditionalCreate(8, RegisterComponent_Conditional_8_Template, 2, 1, "div", 5);
      ...
      \u0275\u0275listener("keydown.enter", function RegisterComponent_Template_input_keydown_enter_13_listener() {
        return ctx.register();
      });
      \u0275\u0275elementEnd()();
      ...
      \u0275\u0275listener("keydown.enter", function RegisterComponent_Template_input_keydown_enter_17_listener() {
        return ctx.register();
      });
      \u0275\u0275elementEnd()();
      ...
      \u0275\u0275listener("keydown.enter", function RegisterComponent_Template_input_keydown_enter_21_listener() {
        return ctx.register();
      });
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(22, "button", 11);
      \u0275\u0275listener("click", function RegisterComponent_Template_button_click_22_listener() {
        return ctx.register();
      });
      \u0275\u0275conditionalCreate(23, RegisterComponent_Conditional_23_Template, 1, 0, "span", 12)(24, RegisterComponent_Conditional_24_Template, 1, 0);
      \u0275\u0275elementEnd()();
...
<div class="auth-shell">
  ...
  `, styles: ['/* angular:styles/component:scss;a8706022ab46378451d4e79e5f69a8e87579c09eedf7caa9371f0a496840c397;C:/js_projects/saylo-v2/frontend/src/app/features/auth/register.component.ts */\n.auth-shell {\n  min-height: 100vh;\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  background:\n    linear-gradient(\n      135deg,\n      #f8f4f0 0%,\n      #ede8ff 100%);\n  padding: 20px;\n  font-family: "Plus Jakarta Sans", sans-serif;\n}\n.auth-card {\n  background: #fff;\n  border-radius: 24px;\n  padding: 40px;\n  width: 100%;\n  max-width: 400px;\n  box-shadow: 0 8px 40px rgba(0, 0, 0, 0.1);\n  text-align: center;\n}\n.auth-logo {\n  width: 56px;\n  height: 56px;\n  background:\n    linear-gradient(\n      135deg,\n      #6C63FF,\n      #F5A623);\n  border-radius: 16px;\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  font-size: 24px;\n  font-weight: 800;\n  color: #fff;\n  margin: 0 auto 20px;\n  box-shadow: 0 4px 16px rgba(108, 99, 255, 0.3);\n}\n.auth-title {\n  font-size: 26px;\n  font-weight: 800;\n  color: #1a1410;\n  margin: 0 0 6px;\n}\n.auth-sub {\n  color: #9c8f85;\n  font-size: 14px;\n  margin: 0 0 28px;\n}\n.auth-error {\n  background: #fff0f0;\n  border: 1px solid #fcc;\n  border-radius: 10px;\n  padding: 10px 14px;\n  color: #e53;\n  font-size: 13px;\n  margin-bottom: 16px;\n}\n.auth-form {\n  text-align: left;\n  display: flex;\n  flex-direction: column;\n  gap: 16px;\n}\n.field label {\n  display: block;\n  font-size: 13px;\n  font-weight: 600;\n  color: #4a3f35;\n  margin-bottom: 6px;\n}\n.field input {\n  width: 100%;\n  padding: 12px 14px;\n  border: 1.5px solid #e8e1d9;\n  border-radius: 12px;\n  font-size: 15px;\n  color: #1a1410;\n  transition: border-color 0.15s;\n  outline: none;\n  box-sizing: border-box;\n}\n.field input:focus {\n  border-color: #6C63FF;\n}\n.auth-btn {\n  width: 100%;\n  padding: 14px;\n  background:\n    linear-gradient(\n      135deg,\n      #6C63FF,\n      #F5A623);\n  color: #fff;\n  border: none;\n  border-radius: 14px;\n  font-size: 15px;\n  font-weight: 700;\n  cursor: pointer;\n  transition: all 0.2s;\n  margin-top: 4px;\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  gap: 8px;\n  min-height: 50px;\n}\n.auth-btn:hover:not(:disabled) {\n  transform: translateY(-1px);\n  box-shadow: 0 6px 20px rgba(108, 99, 255, 0.35);\n}\n.auth-btn:disabled {\n  opacity: 0.7;\n  cursor: not-allowed;\n}\n.spinner {\n  width: 18px;\n  height: 18px;\n  border: 2.5px solid rgba(255, 255, 255, 0.4);\n  border-top-color: #fff;\n  border-radius: 50%;\n  animation: spin 0.7s linear infinite;\n}\n@keyframes spin {\n  to {\n    transform: rotate(360deg);\n  }\n}\n.auth-link {\n  margin-top: 20px;\n  color: #9c8f85;\n  font-size: 14px;\n}\n.auth-link a {\n  color: #6C63FF;\n  font-weight: 600;\n  text-decoration: none;\n}\n@media (max-width: 480px) {\n  .auth-card {\n    padding: 28px 20px;\n  }\n}\n/*# sourceMappingURL=register.component.css.map */\n'] }]
  }], () => [{ type: AuthService }, { type: Router }], null);
})();
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(RegisterComponent, { className: "RegisterComponent", filePath: "src/app/features/auth/register.component.ts", lineNumber: 104 });
})();
export {
  RegisterComponent
};
//# sourceMappingURL=chunk-IN3U7NIT.js.map
